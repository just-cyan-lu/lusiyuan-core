...
function cleanAccessMode(value: unknown): XiaohongshuReplyConfig["accessMode"] {
  return value === "off" || value === "on" || value === "owner_only"
    ? value
    : "owner_only";
}
...
export function normalizeXiaohongshuReplyConfig(value: unknown): XiaohongshuReplyConfig {
  ...
  return {
    version: 1,
    accessMode: cleanAccessMode(source.accessMode),
