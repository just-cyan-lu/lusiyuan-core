...
-- AlterTable
ALTER TABLE "ExternalInboxItem" ALTER COLUMN "syncedAt" SET DATA TYPE TIMESTAMP(3);

-- AlterTable
ALTER TABLE "ExternalPageSnapshot" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMP(3);
...
-- AlterTable
ALTER TABLE "Message" ADD COLUMN     "isIntermediate" BOOLEAN NOT NULL DEFAULT false;
